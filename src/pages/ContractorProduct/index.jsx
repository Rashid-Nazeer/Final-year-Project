...
const ContractorProduct = () => {
    ...
    return (
        <>
        <Helmet>
                <title>Contractor Product Management</title>
                <meta name="description" content="Manage products effectively with our contractor product management tool." />
                <meta name="keywords" content="contractor, product management, real estate, business management" />
                <meta property="og:title" content="Contractor Product Management" />
                <meta property="og:description" content="Access and manage all your real estate products in one place with our dedicated management tool." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content={window.location.href} />
                <meta property="og:image" content="URL_to_an_image_for_social_media_sharing" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Contractor Product Management" />
                <meta name="twitter:description" content="Efficiently manage and oversee your contractor products with our comprehensive tool." />
            </Helmet>
            <Header />
